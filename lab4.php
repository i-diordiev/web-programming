...
<html lang="ua">
    ...
    <body>
        ...
        <aside class="sidebar">
            <button class="side-button-large" onclick="loadText('lab4/description.html')">Постановка задачі</button>
            <details>
                <summary class="side-button-large-tall" style="height: 110px">Способи функціонального
                     застосування JavaScript</summary>
                <button class="side-button-small" onclick="loadText('lab4/url-scheme.html')">Схема URL</button>
                <button class="side-button-small" onclick="loadText('lab4/handler.html')">Обробник подій</button>
                <button class="side-button-small" onclick="loadText('lab4/scripts.html')">Вставка (тег SCRIPT)</button>
            </details>

            <button class="side-button-large" onclick="loadText('lab4/arrays.html')">Масиви (пункт 4)</button>
            <button class="side-button-large" onclick="loadText('lab4/punkt6.html')">Виконання 6 пункту</button>
            <button class="side-button-large" onclick="loadText('lab4/conclusion.html')">Висновки</button>
        </aside>
