...
<html lang="ua">
    ...
    <body>
        ...
        <aside class="sidebar">
            <button class="side-button-large" onclick="loadText('lab2/task.html')">Постановка задачі</button>
            <button class="side-button-large" onclick="loadText('lab2/lists.html')">Списки</button>
            <button class="side-button-large" onclick="loadText('lab2/identifiers.html')">Ідентифікатори</button>
            <button class="side-button-large" onclick="loadText('lab2/margins.html')">Відступи</button>
            <button class="side-button-large" onclick="loadText('lab2/floating.html')">Плаваючі елементи</button>
            
            <details>
                <summary>Селектори</summary>
                <button class="side-button-small" onclick="loadText('lab2/selectors-tag-class.html')">Селектори тегу і класу</button>
                <button class="side-button-small" onclick="loadText('lab2/selectors-other.html')">Інші селектори</button>
                <button class="side-button-small" onclick="loadText('lab2/selectors-groups.html')">Групування селекторів</button>
            </details>
            
            <button class="side-button-large" onclick="loadText('lab2/conclusion.html')">Висновки</button>
        </aside>
